...
{
    public class CurrencyData : BaseComboBoxModel
    {
        ...
        public CurrencyDto SelectedItem { get; set; }
        public List<CurrencyDto> List { get; set; }
    }

    public static partial class CurrencyExtensions
    {
        public static string GetKey(this CurrencyDto dto)
        {
            return $"{dto.Id}";
        }
    }
