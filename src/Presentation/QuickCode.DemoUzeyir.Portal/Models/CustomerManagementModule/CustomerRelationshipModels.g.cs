...
{
    public class CustomerRelationshipData : BaseComboBoxModel
    {
        ...
        public CustomerRelationshipDto SelectedItem { get; set; }
        public List<CustomerRelationshipDto> List { get; set; }
    }

    public static partial class CustomerRelationshipExtensions
    {
        public static string GetKey(this CustomerRelationshipDto dto)
        {
            return $"{dto.Id}";
        }
    }
