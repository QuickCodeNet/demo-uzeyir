...
using QuickCode.DemoUzeyir.Portal.Mapper;
using QuickCode.DemoUzeyir.Portal.ViewEngines;
using QuickCode.DemoUzeyir.Common.Middleware;
using QuickCode.DemoUzeyir.Portal.Middleware;

namespace QuickCode.DemoUzeyir.Portal
{
