...
using QuickCode.DemoUzeyir.Common.Nswag;
...
using LoginRequest = QuickCode.DemoUzeyir.Common.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.DemoUzeyir.Common.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.DemoUzeyir.Common.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;
