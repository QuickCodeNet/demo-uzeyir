...
using QuickCode.DemoUzeyir.Gateway.Messaging;
...
using QuickCode.DemoUzeyir.Gateway.Models;
using QuickCode.DemoUzeyir.Gateway.Extensions;
using QuickCode.DemoUzeyir.Gateway.KafkaProducer;
using Serilog;
using QuickCode.DemoUzeyir.Common.Middleware;
using QuickCode.DemoUzeyir.Gateway.Middleware;

using InMemoryConfigProvider = QuickCode.DemoUzeyir.Gateway.Extensions.InMemoryConfigProvider;
