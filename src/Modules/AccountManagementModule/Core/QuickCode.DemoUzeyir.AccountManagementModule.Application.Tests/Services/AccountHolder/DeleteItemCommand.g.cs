...
{
    public class AccountHolderServiceDeleteTests : IDisposable
    {
        ...
        public AccountHolderServiceDeleteTests()
        {
        ...
        public async Task DeleteItemAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.DeleteAsync(It.IsAny<AccountHolderDto>())).ReturnsAsync(fakeDeleteResponse);
            // Act
            var result = await _service.DeleteItemAsync(fakeDto.AccountId, fakeDto.CustomerId);
            // Assert
            Assert.Equal(ResultCodeSuccess, result.Code);
            Assert.True(result.Value);
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.AccountId, fakeDto.CustomerId), Times.Once);
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<AccountHolderDto>()), Times.Once);
        }
        ...
        public async Task DeleteItemAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.AccountId, fakeDto.CustomerId), Times.Once);
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<AccountHolderDto>()), Times.Never);
        }
