...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(resource => resource
        .AddService(serviceName: "QuickCode.DemoUzeyir.CustomerManagementModule.Api"))
...
builder.Services.AddQuickCodeRepositories("QuickCode.DemoUzeyir.CustomerManagementModule.Persistence", "QuickCode.DemoUzeyir.CustomerManagementModule.Application");
