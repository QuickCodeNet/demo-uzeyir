...
namespace QuickCode.DemoUzeyir.CustomerManagementModule.Persistence.Tests.Repositories
{
    public class IdentificationDocumentRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<IdentificationDocumentRepository>> loggerMock;
        ...
        {
            return new IdentificationDocumentRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
