...
namespace QuickCode.DemoUzeyir.CustomerManagementModule.Persistence.Tests.Repositories
{
    public class CustomerRelationshipRepositoryTests : IDisposable
    {
        ...
        private readonly Mock<ILogger<CustomerRelationshipRepository>> loggerMock;
        ...
        {
            return new CustomerRelationshipRepository(loggerMock.Object, connectionFactoryMock.Object);
        }
