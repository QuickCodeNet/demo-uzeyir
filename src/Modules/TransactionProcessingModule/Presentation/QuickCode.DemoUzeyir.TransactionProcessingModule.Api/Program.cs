...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(resource => resource
        .AddService(serviceName: "QuickCode.DemoUzeyir.TransactionProcessingModule.Api"))
...
builder.Services.AddQuickCodeRepositories("QuickCode.DemoUzeyir.TransactionProcessingModule.Persistence", "QuickCode.DemoUzeyir.TransactionProcessingModule.Application");
