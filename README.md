...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/demouzeyir.git
  ```
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/demouzeyir)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://demouzeyir-gateway.quickcode.net](https://demouzeyir-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://demouzeyir-portal.quickcode.net](https://demouzeyir-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://demouzeyir-gateway.quickcode.net](https://demouzeyir-gateway.quickcode.net)
- **Portal:**
    - link: [https://demouzeyir-portal.quickcode.net](https://demouzeyir-portal.quickcode.net)
- **Module APIs:**
    - link: [https://demouzeyir-identity-module.quickcode.net](https://demouzeyir-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["demouzeyir-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://demouzeyir-identity-module.quickcode.net"
        }
      }
    }
  }
