...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/demo-uzeyir.git
  ```
...
- [ ] In a new terminal, run all tests:
  ```bash
  dotnet test QuickCode.DemoUzeyir.Docker.sln
  ```
...
**DemoUzeyir** is a modular, enterprise-grade .NET solution generated by [quickcode.net](https://quickcode.net).  
...
demo-uzeyir/
  src/
    ...
    Modules/
      ...
      IdentityModule/
    Presentation/
      QuickCode.DemoUzeyir.Gateway/
      QuickCode.DemoUzeyir.Portal/
    Services/
    ...
  docker-compose.yml
  README.md
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/demo-uzeyir)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://demo-uzeyir-gateway.quickcode.net](https://demo-uzeyir-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://demo-uzeyir-portal.quickcode.net](https://demo-uzeyir-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://demo-uzeyir-gateway.quickcode.net](https://demo-uzeyir-gateway.quickcode.net)
- **Portal:**
    - link: [https://demo-uzeyir-portal.quickcode.net](https://demo-uzeyir-portal.quickcode.net)
- **Module APIs:**
    - link: [https://demo-uzeyir-identity-module.quickcode.net](https://demo-uzeyir-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["demo-uzeyir-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://demo-uzeyir-identity-module.quickcode.net"
        }
      }
    }
  }
...
**Last generation Time**: [Generated on: 2026-04-27 14:34:26 UTC]